...
/**
 * Created by Hafizh on 24/05/2016.
 */
public class TinyDB {
    ...
    public ArrayList<Tempat> getListObject(String key) {
        Gson gson = new Gson();

        Type type = new TypeToken<List<Tempat>>() {
        }.getType();
        ArrayList<String> objStrings = getListString(key);
        ArrayList<Tempat> objects = new ArrayList<>();

        for (String jObjString : objStrings) {
            Tempat value = gson.fromJson(jObjString, type);
            objects.add(value);
        }
        return objects;
    }
...
//    }
//
    public void putListObject(String key, ArrayList<Tempat> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Tempat obj : objArray) {
